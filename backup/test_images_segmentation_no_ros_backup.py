...
def main():
    ...
    cv2.imwrite(os.path.join(results_saving_dir, f"visualization.png"), im_label[:, :, ::-1])
    cv2.imwrite(os.path.join(results_saving_dir, f"visualization_refined.png"), im_label_refined[:, :, ::-1])
